...
| [Storage Query Agent](storage-query-agent) | Conversational agent that answers questions by querying storage systems and computer servers. Provides insights into file systems, storage usage, server metrics, and file content. | Custom tool, File System, Server Monitoring, Storage Management  | Conversational | Easy | Single Agent | Horizontal / IT Operations |
